...
| Tests | 3,061 offline, and 194 more that live in the suites run against a broker session |
...
| --- | ---: | :---: |
| Rust unit and integration | 2,246 | No |
| Rust, live | 9 | Yes |
| Python | 815 | No |
| Python, live | 137 | Yes |
| Paper compatibility suite (153 phases) | 48 tests | Yes |
